          ...
          <div className="w-full h-full overflow-hidden max-w-[1720px] mx-auto flex">
            ...
            <div className="w-[4%] h-full flex flex-col justify-between items-center py-3 relative">
              <div className=" flex flex-col items-center justify-center gap-5">
                <div className={`${enviroment===true?'bg-slate-200 rounded-sm':null}`}>
                 <p className="p-2 hover:bg-slate-200"> <AiOutlineEye className={`cursor-pointer`} onClick={()=>setEnviroment(!enviroment)}/></p>
                </div>
