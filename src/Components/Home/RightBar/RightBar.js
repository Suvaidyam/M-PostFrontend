...
const RightBar = () => {
    ...
    return (
        <>
            <div className=" flex flex-col items-center justify-center gap-5 h-[88.5vh] bg-white py-1 relative">
                <div className="flex flex-col justify-between h-full ">
                    <div className="flex flex-col gap-1">
                        <div className={`hover:bg-blue-200 w-8 h-8 flex justify-center items-center
                             cursor-pointer rounded-md  group ${open === true?'bg-blue-200':null}`} 
                              onClick={envirmentOpen}>
                            <AiOutlineEye className={`group-hover:text-blue-600 
