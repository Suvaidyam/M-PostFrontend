...
const CreateWorkSpace = ({ setOpen }) => {
  const { setMsg, setError,setStatus ,setworkSpaceopen, workSpaceopen} = useContext(DataContext);
        ...
        <div className="w-full mt-2">
          <div>
            ...
            <input
              type="text"
              id="name"
              className="outline-blue-500 border-[1.5px] px-2 w-full
             rounded-sm py-1"
          ...
          <div class="mt-4 space-y-4">
            ...
            <div class="flex items-start">
              ...
              <div class="ml-3 text-sm">
                <label for="personal" class="cursor-pointer text-gray-700">
                  Personal
                </label>
            ...
            <div class="flex items-start">
              ...
              <div class="ml-3 text-sm">
                <label for="comments" class=" cursor-pointer text-gray-700">
                  Team
                </label>
            ...
            <div class="flex items-start">
              ...
              <div class="ml-3 text-sm">
                <label for="offers" class=" cursor-pointer text-gray-700">
                  Pubilc
                </label>
