...
import passImg from '../../Assets/password.avif'
    ...
    const ThirdStep = () => {
        if (password?.length > 0) {
            if (password === conformPassword) {
                ...
                toast.error('Invalid Conform Password')
            }
        } else {
            ...
            <div className='w-full h-screen  pt-5'>
                {
                    changePassword === true ?
                        <div className='w-full h-full flex items-center justify-center'>
                            <div>
                                <img src={passImg} alt="IMG" className='w-96' />
                                <div className="flex gap-3">
                                    <p className='text-lg'>Your Password Successfully Updated</p>
                                    <Link to={'/'} className='flex justify-center items-center gap-3 text-blue-600 underline'>  <BiArrowBack /> Back to Login</Link>
                                </div>
                            </div>
                        </div>
                        :
